...
Docker — це вхідний квиток. Kubernetes — це стандарт. Якщо ви не знаєте контейнери у 2026 році, ви не конкурентоспроможні на ринку DevOps.

Переважна більшість організацій використовують або оцінюють Kubernetes. Docker — у більшості вакансій DevOps.
...
У 2026 році:
- **Docker** — це базовий мінімум. Якщо ви не вмієте контейнеризувати застосунок — вам закрито шлях до більшості DevOps-позицій
- **Kubernetes** — знання K8s відрізняє junior від mid-level. Це те, що компанії шукають найактивніше
- **Container security** — сканування образів, підпис образів, runtime security — стає обов'язковим (див. [Фактор 3: DevSecOps](../03-devsecops/))
- **GitOps** — деплой через Git (ArgoCD, Flux) замість `kubectl apply` — стандартна практика
