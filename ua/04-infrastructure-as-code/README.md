...
Більшість зрілих DevOps-команд використовують IaC, а Terraform став де-факто стандартом у цій галузі.
...
### 1. Terraform — основний інструмент

Terraform від HashiCorp — де-факто стандарт IaC. OpenTofu — open-source fork. Концепції ідентичні.

```
Terraform-навички (в порядку пріоритету):
├── Основи HCL
...
- [ ] Знати різницю між Terraform та OpenTofu
