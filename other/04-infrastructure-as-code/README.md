...
- **Порог найма:** Цель этого модуля -- вывести вас на уровень **middle** с модулями, управлением state, CI-проверками и безопасным командным workflow.
...
**Тест:** Можете построить полную инфраструктуру (VPC + EKS + RDS + monitoring) с модулями, remote state и CI/CD? Если да -- вы на уровне middle.
...
**Тест:** Можете спроектировать IaC-стратегию для организации с 10+ команд и 3+ окружений? Если да -- вы на уровне senior.
...
### Упражнение 1: Полная VPC + EKS на Terraform (middle)
...
### Упражнение 2: Remote State и State Management (junior -> middle)
...
### Упражнение 3: CI/CD для Terraform (middle)
...
### Упражнение 4: Тестирование модулей с Terratest (middle -> senior)
...
### Упражнение 5: GitOps с ArgoCD (middle -> senior)
