...
- **Минимальный путь:** Освойте один IaC-инструмент, пишите небольшие конфигурации, настраивайте remote state с locking и привыкайте читать `plan` перед каждым `apply`.
- **Порог найма:** Выйдите на уровень **уверенный** с модулями, управлением state, CI-проверками и безопасным командным workflow.
- **Оставьте на потом:** Sentinel, custom providers, платформенный дизайн орг-уровня и большие программы миграции.
...
В 2026 году IaC -- это **ожидаемый навык** для DevOps-, platform- и cloud-инженеров. На многих собеседованиях без него будет сложно показать зрелый инфраструктурный подход.
