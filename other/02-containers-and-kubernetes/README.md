...
- **Порог найма:** Цель этого модуля -- вывести вас на уровень **уверенный** с Deployments, Services, Ingress, Helm, probes, resource limits и системным troubleshooting.
...
- **Kubernetes** -- часто отделяет стартовый уровень от более уверенного mid-level профиля
