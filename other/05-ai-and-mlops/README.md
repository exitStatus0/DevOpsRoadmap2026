...
**Тест:** Можете построить полный пайплайн от тренировки модели до serving с мониторингом? Если да -- вы на уровне middle.
...
**Тест:** Можете спроектировать и внедрить ML-платформу, которая обслуживает 5+ ML-команд? Если да -- вы на уровне senior.
...
### Упражнение 1: Ежедневное использование ИИ для DevOps (junior)
...
### Упражнение 2: CI/CD для ML-проекта (middle)
...
### Упражнение 3: GPU-нагрузка на K8s (middle -> senior)
...
### Упражнение 4: Model Serving Pipeline (middle -> senior)
...
### Упражнение 5: LLM Serving на K8s (senior)
