...
Три проекта, охватывающие все пять факторов. Каждый модуль ссылается сюда — выбирайте проекты, подходящие к вашему этапу обучения.
...
Демонстрирует: Все 5 факторов. Это ваш «главный» проект.
```
