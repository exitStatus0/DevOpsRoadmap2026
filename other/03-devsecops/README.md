...
- **Порог найма:** Цель этого модуля -- вывести вас на уровень **уверенный**, где вы умеете находить и убирать типовые security-ошибки до production.
...
### Упражнение 1: Гигиена секретов и безопасное хранение (новичок)
